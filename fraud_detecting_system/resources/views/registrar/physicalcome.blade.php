...
if (fileName === "" || fileExt !== "pdf") {
  ...
  <div id="wrapper">
    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="container">
            ...
            <form  action="{{url('apply_request_physical')}}"  onsubmit="validateForm(event)" method="POST" enctype="multipart/form-data" >
                   ...
                   <div class="details personal">
                       ...
                       <div class="fields">
                           ...
                           <div class="input-field">
                               ...
                               <input type="text" placeholder="Enter your name" name="fname"  pattern="[A-Za-z\s]+" title="Only alphabetic characters are allowed" required>
                           </div>
                           <div class="input-field">
                             ...
                             <input type="text" placeholder="Enter your last name" name="lname" pattern="[A-Za-z]+" oninput="sanitizeLastName(event)" required>
                         </div>
                         <div class="input-field">
                           <label>Grand Father Name </label>
                           
                           <input type="text" placeholder="Enter your Grand Father name" name="gfname" oninput="sanitizeGrandFatherName(event)" required>
                       </div>
                       <div class="input-field">
                         <label>ID Number</label>
                      
   
                         <input type="text" placeholder="Enter ID number" name="id" oninput="validateIDNumber(event)" onkeypress="return isNumberKey(event)" required>
   ...
   <small id="request-type-error" style="color: red; display: none;">Please select a valid request type.</small>
                           ...
                           <div class="input-field">
   <label>Email</label>
   <input type="email" placeholder="Enter your email" name="email" id="emailInput" oninput="validateEmail(event)" required>
   <small id="email-error" style="color: red; display: none;">Please enter a valid email address.</small>
                           ...
                           <div class="input-field">    
                             <span id="phoneNumberError" class="error"></span>
                               ...
                               <input type="text" placeholder="Enter mobile number" name="phone" oninput="validatePhoneNumber(event)" onkeypress="return isNumberKey(event)" required>
   ...
   <input type="number" placeholder="Enter Graduation date" name="year" id="yearInput" min="2002" max="2023" required>
  ...
  <div class="fields">
    <p>Faculty/School</p>
    <select class="form-control mb-2" name="school" required id="slct1">
    ...
    <p>Department</p>
    <select class="form-control mb-2" name="department" required id="slct2">
    ...
    <script>
      ...
      let aa = [" computer science","construction technology and management" ,"electrical and computer engineering","mechanical engineering",
