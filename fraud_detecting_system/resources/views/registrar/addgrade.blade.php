...
@endif
                    <form action="{{ route('csstdudent.importa') }}" method="POST" enctype="multipart/form-data">
                          @csrf
                      ...
                      <a class="btn btn-danger float-end" href="{{ route('csstdudent.exporta') }}">Export User Data</a>
                     </form>
