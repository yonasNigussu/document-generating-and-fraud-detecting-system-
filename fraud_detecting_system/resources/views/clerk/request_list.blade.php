  ...
  @include('clerk.sidebar')
    ...
    @if ($lists->payment == 'unpaid')
        <tr>
            ...
            <th>{{$lists->transaction_number}}</th>
            <th>    <span class="badge badge-danger">{{$lists->payment}}</span>
                  </th>
            
            <td><a href="{{URL::to('/clerk_detail',['id' => $lists->id])}}" class="btn btn-sm btn-primary">Detail</a></td>
        </tr>
        @endif
    @endif
@endforeach
