...
if (!/^[0-9]{10}$/.test(phoneNumber) || !phoneNumber.startsWith("09")) {
  error.style.display = "block";
  ...
  <div id="wrapper">
    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="container">
            ...
            <form  action="{{url('letter_apply_request')}}"  onsubmit="validateForm(event)" method="POST" enctype="multipart/form-data" >
   ...
   <div class="row">
     ...
     <div class="col-sm-9">
       <div class="custom-control custom-radio">
         ...
         <label class="custom-control-label" checkdate for="customRadio1">Regular</label>
       </div>
       <div class="custom-control custom-radio">
