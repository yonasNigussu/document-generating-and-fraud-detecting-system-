...
<div id="pf1" class="pf w0 h0" data-page-no="1">
  ...
  <div class="pc pc1 w0 h0"><img class="bi x0 y0 w1 h1" alt="" src="{{ asset('degree/bg1.png') }}"/><div class="t m0 x1 h2 y1 ff1 fs0 fc0 sc0 ls0 ws0">                         <span class="ff2 fs1 fc1">ድሬዳዋ<span class="ff3"> </span>ዩኒቨርሲቲ</span></div><div class="t m0 x1 h3 y2 ff4 fs2 fc2 sc0 ls0 ws0">                                                  Dire Dawa University </div><div class="t m0 x2 h3 y3 ff4 fs2 fc2 sc0 ls0 ws0">                                                          <span class="fs3">Tel: +251-251127862</span></div><div class="t m0 x2 h4 y4 ff4 fs3 fc2 sc0 ls0 ws0">                                                                            p.o.Box    1362, Dire Dawa, Ethiopia   </div><div class="t m0 x2 h5 y5 ff3 fs3 fc2 sc0 ls0 ws0"> </div><div class="t m0 x2 h6 y6 ff4 fs1 fc0 sc0 ls0 ws0">                                           TO WHOM IT MAY CONCERN  
    <img src="{{ asset('studentImage/' . $photo->image) }}" alt="no photo" style="display: grid; grid-template-columns: repeat(3, 1fr); grid-template-rows: repeat(3, 1fr); width: 600px; height: auto; background: transparent;">
