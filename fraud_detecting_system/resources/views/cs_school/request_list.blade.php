...
<body id="page-top">
  ...
  @include('cs_school.sidebar')
    
    <!-- TopBar -->
    @include('cs_school.navbar')
        <!-- Topbar -->
        <!-- Container Fluid-->
    ...
    <?php $department = 'computer science'; ?>
    ...
    @if($department == $request_department)
        <tr>
            ...
            <td><a href="{{URL::to('/detailcs',['id' => $lists->id])}}" class="btn btn-sm btn-primary">Detail</a></td>
        </tr>
    @endif
    @endif
@endforeach
