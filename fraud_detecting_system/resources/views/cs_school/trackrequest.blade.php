...
<head>
  ...
  <link href="{{asset('registrar/vendor/datatables/dataTables.bootstrap4.min.css')}}" rel="stylesheet">
</head>
...
<body id="page-top">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    @foreach($filteredRows as $lists)

                      <tr>
                        <td><a href="#">{{$lists->id}}</a></td>
  ...
  <!-- Page level plugins -->
  <script src="{{asset('registrar/vendor/datatables/jquery.dataTables.min.js')}}"></script>
  <script src="{{asset('registrar/vendor/datatables/dataTables.bootstrap4.min.js')}}"></script>
